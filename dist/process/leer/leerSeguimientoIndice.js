...
exports.leerSeguimientoIndice = void 0;
...
const leerSeguimientoIndice = () => {
    try {
        const contenido = fs.readFileSync(seguimientoPath, 'utf-8');
        const seguimientoArray = JSON.parse(contenido);
...
exports.leerSeguimientoIndice = leerSeguimientoIndice;
